...
use Mintmesh\Services\IntegrationManager\ICIMSManager;

class icims extends Command {
	...
	public function __construct()
        {
            ...
            $this->ICIMSManager = new ICIMSManager();
        }
    ...
    public function fire()
    {
        ...
        $res = $this->ICIMSManager->intiateRequest($jobId);
