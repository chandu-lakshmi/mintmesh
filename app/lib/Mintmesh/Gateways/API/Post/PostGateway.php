...
//        $this->neoGlobalRepository = $neoGlobalRepository;
    ...
    public function sendJobPostEmailToContacts ($emailData) {
        ...
        $dataSet['apply_link']          = Config::get('constants.MM_ENTERPRISE_URL') . "/email/candidate-details/share?ref=" . $refCode."&flag=0&jc=0";
        $dataSet['refer_link']          = Config::get('constants.MM_ENTERPRISE_URL') . "/email/referral-details/share?ref=" . $refCode."&flag=0&jc=0";
        $dataSet['view_jobs_link']      = Config::get('constants.MM_ENTERPRISE_URL') . "/email/all-jobs/share?ref=" . $refCode."&jc=0";
