...
<p>Amount will be processed in 7 days and it will be credited to your bank details which was provided during payout.</p>
</div>
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                <tr>
                                                    <td  class="textContent" style="padding:10px 30px 10px;">
                                                        <p style="color:#000000;font-family: 'arial', sans-serif;font-size:20px;font-weight:normal;margin:0px !important;text-align:left;float:left !important;width:100%;">Sincerely,</p>
                                                        
                                                        <p style="text-align:left;font-family: 'arial', sans-serif;font-size:20px;margin:0;color:#777777;float:left !important;width:100%;">(MintMesh Team)</p>
                                                    </td>
                                                </tr>
                                            </table>
                                            <!-- // CONTENT TABLE -->
