...
<table bgcolor="#FFFFFF"  border="0" width="500" cellpadding="0" cellspacing="0" class="main_table" style="background:#fff;  margin:20px auto 0px;" >
  ...
  <tr>
    <td valign="top" class="textContent" style="padding:20px 20px 10px;line-height:135%;letter-spacing:0.2px;font-size:18px; font-weight:normal; color:#777777;">
      ...
      <p>The password for your MintMesh Enterprise account <a href="mailto:<?php echo $email;?>" target="_blank"><?php echo $email;?></a> was recently changed.</p>
      <p>If you requested this change, please ignore this email.</p>
      <p>If you don't recognize this activity, please reset your MintMesh Password.</p>
       </td>
  </tr>
  <tr>
