            ...
            <tr style="padding-top:0;">
                <td align="center" valign="top">
                    ...
                    <table border="0"  cellspacing="0" width="500" class="flexibleContainer">
                        <tr>
                            <td style="padding:0px 30px;" align="center" valign="top" width="500" class="flexibleContainerCell">
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="70%" class="emailButton" style="background-color: #269b7b;border-radius:8px;cursor:pointer;">
                                    <tr>
                                        <td align="center" valign="middle" class="buttonContent" >
                                            <a style="color:#FFFFFF;text-decoration:none;font-family: 'Roboto', sans-serif;font-size:20px;line-height:80%;padding-top:20px;padding-bottom:20px;padding-right:15px;padding-left:15px;display:block;" href="<?php echo $link ; ?>" target="_blank">Reset Password</a>
                                        </td>
                                    </tr>
                                </table>
                                <!-- // CONTENT TABLE -->
                        ...
                        <!--<tr>
                            <td style="padding:10px 30px 10px">
                                <div style="text-align:left;font-family: 'Roboto', sans-serif;font-size:20px;margin-bottom:0;color:#777777;line-height:135%;letter-spacing:0.2px;">
                                    <p>Please note that this link is valid only for <?php echo $hrs ; ?> hours.</p>
