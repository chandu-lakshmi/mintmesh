...
<table bgcolor="#FFFFFF"  border="0" cellpadding="0" cellspacing="0" class="main_table" style="background:#fff;  margin:0px auto;" >
  <tr>
    <td align="center" valign="top"  style="padding:20px 30px 10px;"><img src="https://staging.mintmesh.com/public/images/mintmesh-logo.png"   align="center" style="max-width:100%;text-align:center;" alt="logo" title="Text">
      <h2 style="text-align:center;font-weight:normal;font-family: 'Roboto', sans-serif;font-weight:300;font-size:24px;margin-bottom:10px;margin-top:20px;color:#000000;">Change your password</h2>
      <hr style="border-top:1px solid #c8c8c8;margin-top:20px;"></td>
  </tr>
  <tr>
    <td valign="top" class="textContent" style="padding:20px 30px 10px;line-height:135%;letter-spacing:0.2px;font-size:18px; font-weight:normal; color:#777777;">
      ...
      <p style="text-align:center; margin-top:50px;" ><a style="color:#FFFFFF;text-decoration:none;font-family: 'Roboto', sans-serif;font-size:20px;padding-top:20px;padding-bottom:20px;padding-right:15px;padding-left:15px;display: block; background:#269b7b; width:60%; margin:0px auto; border-radius:5px; line-height:20px; " href="#" target="_blank">Reset Password</a> </p></td>
  </tr>
  <tr>
    <td valign="top" class="textContent" style="padding:30px 30px 10px;font-size:18px; font-weight:normal; color:#777777;  line-height:135%;"><p style="color:#333333; font-family: 'Roboto', sans-serif;font-size:18px;font-weight:normal;margin-top:0;margin-bottom:0px;text-align:left;">Sincerely</p>
      <p style="color:#777777;font-size:18px; margin:5px 0px 0px; ">MintMesh Team</p></td>
  </tr>
  <tr>
    <td valign="top" class="textContent" style="padding:10px 30px 20px;font-size:18px; font-weight:normal; color:#777777; text-align:center;line-height:135%;"><hr style="border-top:1px solid #c8c8c8;margin-top:5px;margin-bottom:20px;">
