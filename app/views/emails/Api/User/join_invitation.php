...
td[class="flexibleContainerBox1"], td[class="flexibleContainerBox1"] table {display: block;width: 100%;text-align: left;}
...
.btn_pad_app , .btn_pad_google{
padding:0px 30px!important;
}
td[class="flexibleContainerBox1"], td[class="flexibleContainerBox1"] table {
                                        ...
                                        <td align="center" valign="top">
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                <tr>
                                                    ...
                                                    <h2 style="text-align:center;font-weight:normal;font-family: 'Roboto', sans-serif;font-size:30px;margin-bottom:35px;margin-top:0px; color:#cc6e35;line-height:135%;letter-spacing:0.4px;font-weight:300;" class="wish_txt">MintMesh Invitation</h2>
...
<tr>
<td align="left" valign="top" class="flexibleContainerBox1">
<table border="0" cellpadding="0" cellspacing="0" width="210" style="max-width:100%;">
<tr>
<td align="left" class="textContent btn_pad_app" style="padding:0px 0px 0px 50px;">
<a href="#" class="appstore_btn" target="_blank"></a>
</td>
</tr>
</table>
</td>
<td align="right" valign="middle" class="flexibleContainerBox1">
<table class="flexibleContainerBoxNext" border="0" cellpadding="0" cellspacing="0" width="210" style="max-width:100%;">
<tr>
<td align="left" class="textContent btn_pad_google" style="padding:0px 50px 0px 0px;">
<a href="#" class="googleplay_btn" target="_blank"></a>
</td>
</tr>
</table>
</td>
