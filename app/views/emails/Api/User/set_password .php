...
<table bgcolor="#FFFFFF" width="500" border="0" cellpadding="0" cellspacing="0" class="main_table" style="background:#fff;  margin:20px auto 0px;" >
  <tr>
    <!--<td align="center" valign="top"  style="padding:20px 20px 10px;"><img src="<?php echo $public_url ; ?>images/mintmesh-logo.png"   align="center" style="max-width:100%;text-align:center;" alt="logo" title="Text">-->
      <h2 style="font-weight:normal;font-family: 'arial', sans-serif;font-weight:300;font-size:24px;margin-bottom:10px;margin-top:20px;margin-left:14px;color:#808080;"><b>User Account Activation</b></h2>
  ...
  <tr>
    <td valign="top" class="textContent" style="padding:20px 20px 10px;line-height:135%;letter-spacing:0.2px;font-size:18px; font-weight:normal; color:#777777;">
        <h3 style="color:#000000;line-height:125%;font-family: 'arial', sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:0px;text-align:left;">Hello <b><?php echo ucfirst($name) ; ?>,</b></h3>
                    <p style="color:#000000">You have been added as a new user by <b><?php echo $company_name ; ?></b> in Mintmesh enterprise with <b><?php echo $emailid ; ?></b></p>
      <p style="color:#000000">Please click the link below to create a password and activate your account, this link will expire in 48 hours.</p>
  ...
  <tr>
    <td valign="top" class="textContent" style="padding:30px 20px 10px;font-size:18px; font-weight:normal; color:#777777;  line-height:135%;"><p style="color:#333333; font-family: 'arial', sans-serif;font-size:18px;font-weight:normal;margin-top:0;margin-bottom:0px;text-align:left;">Thank you, </p>
        <p style="color:#000000;font-size:18px; margin:5px 0px 0px; "><b><?php echo $company_name ;?></b></p></td>
  </tr>
  <tr>
