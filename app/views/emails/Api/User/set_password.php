...
<table bgcolor="#FFFFFF" width="500" border="0" cellpadding="0" cellspacing="0" class="main_table" style="background:#fff;width:100%" >
  ...
  <tr>
    <td valign="top" class="textContent" style="padding:30px 20px 10px 0px;font-size:16px; font-weight:normal; color:#777777;  line-height:135%;"><p style="color:#333333; font-family: 'arial', sans-serif;font-size:16px;font-weight:normal;margin-top:0;margin-bottom:0px;text-align:left;">Thank you, </p>
