...
.buttonContent{color:#FFFFFF; font-family: 'Roboto', sans-serif; font-size:18px; font-weight:bold; line-height:100%; padding:15px; text-align:center;}
                                        ...
                                        <td align="center" valign="top">
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                <tr>
                                                    ...
                                                    <h2 style="text-align:left;font-weight:normal;font-family: 'Roboto', sans-serif;font-size:30px;margin-bottom:35px;margin-top:0px; color:#cc6e35;line-height:135%;letter-spacing:0.4px;font-weight:300;">Thank you for joining MintMesh</h2>
                    ...
                    <table border="0" cellpadding="30" cellspacing="0" width="500" class="flexibleContainer">
                        <tr>
                            <td style="padding-top:0;" align="center" valign="top" width="500" class="flexibleContainerCell">
                                ...
                                <!-- CONTENT TABLE // -->
                                <table border="0" cellpadding="0" cellspacing="0" width="70%" class="emailButton" style="background-color: #269b7b;border-radius:8px;cursor:pointer;">
                                    <tr>
                                        <td align="center" valign="middle" class="buttonContent" >
                                            <a style="color:#FFFFFF;text-decoration:none;font-family: 'Roboto', sans-serif;font-size:20px;line-height:80%;padding-top:5px;padding-bottom:5px;padding-right:15px;padding-left:15px;display:block;" href="<?php echo $link ; ?>" target="_blank">Activate Account</a>
                                        </td>
                                    </tr>
                                </table>
                                <p class="fontsize">
