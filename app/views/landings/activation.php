...
<body>
<table cellspacing="0" cellpadding="0" style="border-collapse:collapse;font-size:16px;font-family:open sans, Helvetica, sans-serif; min-width:320px;width:100%; background:#fbfbfb;">
		<tbody>
        ...
        <tr style="padding:10px;"><td colspan="3"><table cellspacing="0" cellpadding="0" style="font-family:open sans, Helvetica, sans-serif; font-size:16px; min-width:300px;width:80%; max-width:600px;  padding: 20px; background:#f1f1f1;   margin: 0 auto; border: 1px solid #cbcbcb;
  border-radius: 5px;">
